...
import instruclar from "../images/background_instrucoes_claro.png";
...
export default function Instrucoes() {
  ...
  const bgImage = theme === "dark" ? instrucoesesc : instruclar;
      ...
      <div className="min-h-screen py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12 bg-[#00556B]/50 backdrop-md p-8 ">
            <h1 className="text-4xl font-bold text-foreground mb-4">Instruções de uso</h1>
              ...
              >
                <CardHeader>
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-full bg-ocean-500 flex items-center justify-center text-foreground font-bold text-lg">
                      {passo.numero}
                    </div>
                    <div className="flex-1">
                      ...
                      <p className="text-foreground">{passo.descricao}</p>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
          ...
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-foreground text-center mt-10 mb-8">
                ...
                <Card key={index} className="glass-card border-white/20">
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="text-foreground font-semibold">{parametro.nome}</h3>
                        <p className="text-foreground text-sm">{parametro.valorIdeal}</p>
                      </div>
                      <div
