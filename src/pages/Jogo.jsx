...
// Substituir o componente Image do Next.js pelo <img> nativo
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            <CardContent className="p-6">
              <div className="aspect-video bg-black/20 rounded-lg flex items-center justify-center mb-4 relative overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-black/40">
                  <Button size="lg" className="aqua-button">
          ...
          <div className="space-y-6">
            <Card className="glass-card border-white/20">
              <CardHeader>
                <CardTitle className="text-white text-xl">Sobre o Jogo</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-white/80 mb-4">
                  O AquaTech Game é um simulador educativo que ensina os fundamentos da aquariofilia de forma divertida
                  e interativa. Monte seu aquário virtual, cuide dos peixes e aprenda sobre os parâmetros ideais da
                  água.
                </p>
            ...
            <Button size="lg" className="w-full aqua-button text-lg py-6">
              <Play className="w-6 h-6 mr-2" />
              Jogar Agora
            </Button>
          </div>
            ...
            {recursos.map((recurso, index) => (
              ...
              >
                <CardContent className="p-6 text-center">
                  <div className="w-12 h-12 bg-primary/20 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-primary group-hover:text-white transition-all duration-300">
                    {recurso.icon}
                  </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {screenshots.map((screenshot, index) => (
              <Card
                key={index}
                className="glass-card border-white/20 hover:border-white/40 transition-all duration-300 group overflow-hidden"
              >
                <div className="relative">
                  <Img
                    src={screenshot.imagem || "/placeholder.svg"}
